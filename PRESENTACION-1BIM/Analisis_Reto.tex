...
\begin{itemize}
    ...
    \item \textbf{Seguridad:} Se utilizarán sesiones nativas de Django para la autenticación segura entre cliente y servidor. Las reglas comerciales (como el MOQ) deben validarse de manera estricta en el Backend.
...
graph TD
    ...
    subgraph Backend [Capa Backend - Django REST]
        ...
        Security[Servicio Autenticación Sesiones]
